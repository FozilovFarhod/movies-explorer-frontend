  ...
  return (
    ...
    <nav className={`navigation${isOpen ? '_visible' : '_hidden'}`}>
      <ul className='navigation__links'>
          <li className='navigation__list-item navigation__main-page-link'><NavLink exact to='/' activeClassName='navigation__link_active' className='navigation__link page__link-transparency'>Главная</NavLink></li>
